...
print('Pickling out')
ironic_data = np.load('ironic_semeval.npy')
non_ironic_data = np.load('non_ironic_semeval.npy')
print('Number of ironic tweets :', len(ironic_data))
print('Number of non-ironic tweets :', len(non_ironic_data))
